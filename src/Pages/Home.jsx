...
function Home(){
    return(
        ...
        <div className="flex flex-col items-center bg-[#cadec9] rounded-2xl p-4 m-5 g-40 h-100 from-neutral-800 to-neutral-900">
            ...
            <div>
                ...
                <Link to="addExp">
                <button className="w-50 bg-[#42813f]  text-white font-medium border-none rounded-[10px] px-8 py-5 text-[17px] cursor-pointer flex items-center gap-2 hover:bg-[#1f5c1bcc] hover:shadow-[5px_5px_5px_5px_rgba(168,224,91,0.696)] transition-all ease-in hover:scale-105"><FaPlus/> Add Expenses</button></Link>
            </div>
